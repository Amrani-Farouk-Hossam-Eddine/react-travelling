...
const Footer = () => {
  return (
    <div className="w-full mt-24 bg-gray-900 text-gray-300 py-2 px-2">
      <div className="max-w-[1140px] mx-auto grid grid-cols-2 md:grid-cols-6 border-b-2 border-gray-600 py-8 px-4">
        <div>
      ...
      <div className="flex flex-col max-w-[1140px] px-2 py-4 mx-auto justify-between sm:flex-row text-center text-gray-500">
